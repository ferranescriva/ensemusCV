...
```bash
git clone https://doi.org/10.5281/zenodo.20642359.git
cd ensemusCV
python3 -m venv .venv
...
Escrivà-Llorca, F. (2026). *Cartografia de les Ensenyances Musicals a la Comunitat Valenciana* (v0.1) [Dataset, codi i mapa interactiu]. GitHub / Zenodo. https://doi.org/10.5281/zenodo.20642359
