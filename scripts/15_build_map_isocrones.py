...
iso_30 = folium.FeatureGroup(name="Cobertura 30 min (vehicle)", show=False)
iso_60 = folium.FeatureGroup(name="Cobertura 60 min (vehicle)", show=False)

for feat in isocrones['features']:
    props = feat.get('properties', {})
    val   = props.get('value', 0)
    nom   = props.get('centre_nom', '')
...
titol += "509 centres - Financament public GVA 2024 - Isocrones 30/60 min</span></div>"
...
llegenda += "<br><b>Capes d'accessibilitat</b><br>"
llegenda += "<span style='color:#2E8B57'>&#9632;</span> Cobertura 30 min (vehicle)<br>"
llegenda += "<span style='color:#85C1E9'>&#9632;</span> Cobertura 60 min (vehicle)<br>"
...
print("Isocrones afegides: " + str(len(isocrones['features'])))